...
int main()
{
    ...
    // string
    // char name[3] = {'m', 'y', '\0'}; //\0 is called null character
    // char str1[65], str2[98], str3[32];
    // strcpy(str1, "Harry"); // copies string "harry" to str 1
    // printf(str1);
    // printf("\n");
    // strcpy(str2, "Rohan");
    // printf(str2);
    ...
    // strcpy(str1, name);               // output is 'my'
    // printf("%d", strcmp(str1, str2)); // comparing str1 nd str2// since harry is smaller than rohan so -1
